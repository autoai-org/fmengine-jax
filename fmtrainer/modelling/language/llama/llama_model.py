...
from fmtrainer.modelling.language.llama.llama_config import LLaMAConfig
from fmtrainer.modelling.common.attn_utils import precompute_freqs_cis, apply_rotary_emb
